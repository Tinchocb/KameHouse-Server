...
var CanonicalTimeline = []*TimelineMilestone{
	...
	},
	{
		...
		Order:        18,
		Year:         "Año 779",
		Title:        "Dragon Ball Super: Torneo del Universo 6",
		Era:          "dbs",
		MediaType:    "SHOW",
		MediaID:      62715,
		TmdbID:       62715,
		StartEpisode: 28,
		EndEpisode:   41,
		Description:  "Enfrentamiento contra el Universo 6 de Champa; debut de Hit y el Kaio-ken Blue.",
		CanonStatus:  "CANON",
		Importance:   "CRUCIAL",
	},
	{
		ID:           "m_dbs_copy_vegeta",
		Order:        19,
		Year:         "Año 779",
		Title:        "Dragon Ball Super: La Amenaza de Commeson (Vegeta Copia)",
		Era:          "dbs",
		MediaType:    "SHOW",
		MediaID:      62715,
		TmdbID:       62715,
		StartEpisode: 42,
		EndEpisode:   46,
		Description:  "El Agua Sobrenatural absorbe a Vegeta en Pot-au-feu; Goku Blue vs. Vegeta Copia.",
		CanonStatus:  "CANON",
		Importance:   "RECOMMENDED",
	},
	{
		...
		Order:        20,
		Year:         "Año 779 - 780",
		Title:        "Dragon Ball Super: Saga de Goku Black y Zamasu",
		Era:          "dbs",
		MediaType:    "SHOW",
		MediaID:      62715,
		TmdbID:       62715,
		StartEpisode: 47,
		EndEpisode:   76,
		Description:  "La cruzada mortal de Zamasu y Goku Black en el futuro; Vegetto Blue y el borrado de Zeno-sama.",
		CanonStatus:  "CANON",
		Importance:   "CRUCIAL",
	},
	{
		...
		Order:        21,
		Year:         "Año 780",
		Title:        "Dragon Ball Super: Torneo de Exhibición Zeno-sama",
		Era:          "dbs",
		MediaType:    "SHOW",
		MediaID:      62715,
		TmdbID:       62715,
		StartEpisode: 77,
		EndEpisode:   81,
		Description:  "Universo 7 vs. Universo 9; sentencia de borrado y aparición de Toppo y Jiren.",
		CanonStatus:  "CANON",
		Importance:   "CRUCIAL",
	},
	{
		ID:           "m_dbs_reclutamiento",
		Order:        22,
		Year:         "Año 780",
		Title:        "Dragon Ball Super: Reclutamiento del Universo 7",
		Era:          "dbs",
		MediaType:    "SHOW",
		MediaID:      62715,
		TmdbID:       62715,
		StartEpisode: 82,
		EndEpisode:   96,
		Description:  "Goku y Gohan reclutan a 17, 18, Roshi y a Freezer desde el infierno.",
		CanonStatus:  "CANON",
		Importance:   "CRUCIAL",
	},
	{
	...
	{
		ID:           "m_db_gt_black_star",
		Order:        26,
		Year:         "Año 789 (Línea Expandida)",
		Title:        "Dragon Ball GT: Esferas de Estrella Negra",
		Era:          "dbgt",
		MediaType:    "SHOW",
		MediaID:      12697,
		TmdbID:       12697,
		StartEpisode: 1,
		EndEpisode:   16,
		Description:  "Pilaf infantiliza a Goku; viaje galáctico con Trunks, Pan y Gill.",
	...
	},
	{
		...
		Title:        "Dragon Ball GT: Venganza de Baby y SSJ4",
		Era:          "dbgt",
		MediaType:    "SHOW",
		MediaID:      12697,
		TmdbID:       12697,
		StartEpisode: 17,
		EndEpisode:   40,
		Description:  "Baby posee a Vegeta e infecta la Tierra; despertar del Super Saiyajin 4.",
		CanonStatus:  "EXPANDED",
		Importance:   "RECOMMENDED",
	},
	{
		ID:           "m_db_gt_super17",
		Order:        28,
		Year:         "Año 790 (Línea Expandida)",
		Title:        "Dragon Ball GT: Super Androide 17",
		Era:          "dbgt",
		MediaType:    "SHOW",
		MediaID:      12697,
		TmdbID:       12697,
		StartEpisode: 41,
		EndEpisode:   47,
		Description:  "El portal del infierno libera a los villanos; fusión de los 17 en el Super Androide definitivo.",
		CanonStatus:  "EXPANDED",
		Importance:   "RECOMMENDED",
	},
	{
		...
		Order:        29,
		Year:         "Año 790 (Línea Expandida)",
		Title:        "Dragon Ball GT: Dragones Malignos y Despedida",
		Era:          "dbgt",
		MediaType:    "SHOW",
		MediaID:      12697,
		TmdbID:       12697,
		StartEpisode: 48,
		EndEpisode:   64,
		Description:  "Energía negativa acumulada da vida a los 7 dragones; Gogeta SSJ4 y Genkidama Universal.",
		CanonStatus:  "EXPANDED",
		Importance:   "RECOMMENDED",
	},
	{
