...
func (s *AutoSelect) search(ctx context.Context, media *anilist.CompleteAnime, episodeNumber int, profile *dto.AutoSelectProfile) ([]*hibiketorrent.AnimeTorrent, error) {
...
func (s *AutoSelect) getProvidersToSearch(profile *dto.AutoSelectProfile) []string {
