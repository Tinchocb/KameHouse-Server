...
func TestAutoSelect_Filter(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			profile: &dto.AutoSelectProfile{
				MultipleAudioPreference: dto.AutoSelectPreferenceOnly,
			},
		...
		},
		{
			...
			profile: &dto.AutoSelectProfile{
				MultipleAudioPreference: dto.AutoSelectPreferenceNever,
			},
		...
		},
		{
			name: "Batch only",
			profile: &dto.AutoSelectProfile{
				BatchPreference: dto.AutoSelectPreferenceOnly,
			},
		...
		},
		{
			name: "Batch never",
			profile: &dto.AutoSelectProfile{
				BatchPreference: dto.AutoSelectPreferenceNever,
			},
...
func TestAutoSelect_Sort(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			profile: &dto.AutoSelectProfile{
				MultipleAudioPreference: dto.AutoSelectPreferencePrefer,
			},
		...
		},
		{
			...
			profile: &dto.AutoSelectProfile{
				...
				MultipleAudioPreference: dto.AutoSelectPreferencePrefer, // +15
			},
			// t1: 1080p (+100) = 100
			// t2: 720p (0) = 0
		...
		},
		{
			...
			profile: &dto.AutoSelectProfile{
				MultipleAudioPreference: dto.AutoSelectPreferenceAvoid, // -15
			},
			// t3: -15
			// Others: 0
