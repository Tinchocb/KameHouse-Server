...
func GetKameHouseFlags() KameHouseFlags {
	...
	flag.Usage = func() {
		...
		if runtime.GOOS == "windows" {
			...
			fmt.Printf("Usage: KameHouse [flags]\n\n")
		}
		fmt.Printf("Flags:\n")
		fmt.Printf("  --datadir string              directory that contains all KameHouse data\n")
