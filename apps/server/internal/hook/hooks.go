...
type Manager interface {
	...
	OnScanProgress() *Hook[hook_resolver.Resolver]
...
func (m *ManagerImpl) initHooks() {
	...
	m.onScanProgress = &Hook[hook_resolver.Resolver]{}
...
func (m *ManagerImpl) OnScanProgress() *Hook[hook_resolver.Resolver] {
	if m == nil {
		return &Hook[hook_resolver.Resolver]{}
	}
	return m.onScanProgress
}
