...
type (
	...
	AnimeSearchOptions struct {
		// The media object provided by KameHouse.
	...
	AnimeTorrent struct {
		...
		// Leave this empty if you want KameHouse to format the size.
		...
		// Else, KameHouse will parse the torrent name to determine if it's a batch.
		IsBatch bool `json:"isBatch,omitempty"`
		// Episode number of the torrent.
		// Return -1 if unknown / unable to determine and KameHouse will parse the torrent name.
		EpisodeNumber int `json:"episodeNumber,omitempty"`
		// Release group of the torrent.
		// Leave this empty if you want KameHouse to parse the release group from the name.
