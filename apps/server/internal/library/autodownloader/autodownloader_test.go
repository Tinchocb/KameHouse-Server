...
func TestIsConstraintsMatch(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			rule:     &dto.AutoDownloaderRule{MinSize: "1KB"},
			expected: true,
		},
		{
		...
		},
		{
			...
			rule:     &dto.AutoDownloaderRule{MaxSize: "2KB"},
			expected: true,
		},
		{
			name:     "Max size fail",
...
func TestIsExcludedTermsMatch(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			rule:     &dto.AutoDownloaderRule{ExcludeTerms: []string{"French"}},
			expected: false,
		},
		{
...
func TestGetRuleProfiles(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			rule:     &dto.AutoDownloaderRule{ProfileID: nil},
			expected: []uint{2, 3},
			profiles: []*dto.AutoDownloaderProfile{
				{DbID: 1, Global: false},
				{DbID: 2, Global: true},
		...
		},
		{
			...
			rule:     &dto.AutoDownloaderRule{ProfileID: lo.ToPtr(uint(2))},
			expected: []uint{2, 3},
			profiles: []*dto.AutoDownloaderProfile{
				{DbID: 1, Global: false},
				{DbID: 2, Global: true},
...
func TestIsEpisodeAlreadyHandled(t *testing.T) {
	...
	localFiles := []*dto.LocalFile{
		...
		{MediaId: 1, Metadata: &dto.LocalFileMetadata{Episode: 6, Type: dto.LocalFileTypeMain}},
		{MediaId: 2, Metadata: &dto.LocalFileMetadata{Episode: 1, Type: dto.LocalFileTypeMain}},
		{MediaId: 21, Metadata: &dto.LocalFileMetadata{Episode: 1, Type: dto.LocalFileTypeMain}},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 30},
						{Term: "Batch, Dual-Audio, Dub", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: -100},
					},
					MinimumScore: 10,
				},
			},
		...
		},
		{
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					Conditions: []dto.AutoDownloaderCondition{
						{Term: `(BD|Blu-?ray|BDRip)`, IsRegex: true, Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 100},
						{Term: "HEVC, x265", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 20},
					},
					MinimumScore: 110,
				},
			},
		...
		},
		{
			...
			profiles: []*dto.AutoDownloaderProfile{
				...
				},
				{
					...
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "Nippon-Yasan, MTBB", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 40},
					},
					MinimumScore: 50,
				},
			},
		...
		},
		{
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					Conditions: []dto.AutoDownloaderCondition{
						{Term: `v[2-9]`, IsRegex: true, Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 15},
						{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10},
					},
					MinimumScore: 20,
				},
			},
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					...
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10},
						{Term: "HEVC, x265, 10bit, 10-bit", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: -500},
					},
					MinimumScore: 0,
				},
			},
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					Name: "English Dub",
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "Dual Audio", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 150},
						{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10},
					},
					MinimumScore: 50,
				},
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					...
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "v2", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 100},
					},
					MinimumScore: 0,
				},
			},
...
func TestIsProfileValidChecks(t *testing.T) {
	...
	tests := []struct {
		name    string
		torrent *NormalizedTorrent
		profile *dto.AutoDownloaderProfile
		isValid bool
	}{
		{
			...
			profile: &dto.AutoDownloaderProfile{
				...
				MinSize:    "500MB",
				Conditions: []dto.AutoDownloaderCondition{
					{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionRequire},
				},
			},
			isValid: true,
		},
		...
		},
		{
			...
			profile: &dto.AutoDownloaderProfile{
				Conditions: []dto.AutoDownloaderCondition{
					{Term: "SubsPlease", Action: dto.AutoDownloaderProfileRuleFormatActionBlock},
				},
			},
			isValid: false,
		},
		{
			...
			profile: &dto.AutoDownloaderProfile{
				Conditions: []dto.AutoDownloaderCondition{
					{Term: "AV1", Action: dto.AutoDownloaderProfileRuleFormatActionRequire},
				},
			},
			isValid: false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			rule: &dto.AutoDownloaderRule{
				...
				EpisodeType:         dto.AutoDownloaderRuleEpisodeRecent,
				ComparisonTitle:     "Sousou no Frieren",
				TitleComparisonType: dto.AutoDownloaderRuleTitleComparisonLikely,
			...
			profiles: []*dto.AutoDownloaderProfile{
				{
					...
					Global: true,
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 25},
						{Term: "720p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10},
						{Term: "SubsPlease", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10},
					},
					Resolutions:  []string{"1080p", "720p"},
					MinSeeders:   20,
					MinimumScore: 0,
				},
				{
					...
					Global: false,
					Conditions: []dto.AutoDownloaderCondition{
						{Term: "LowQuality", Action: dto.AutoDownloaderProfileRuleFormatActionBlock},
					},
					Resolutions:  []string{"1080p"},
					MinSeeders:   50,
					MinimumScore: 10,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for _, profile := range tt.profiles {
				err = db.InsertAutoDownloaderProfile(ad.database, profile)
				require.NoError(t, err)
			}
			err = db.InsertAutoDownloaderRule(ad.database, tt.rule)
			require.NoError(t, err)
...
func TestDelayIntegration(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			profile: &dto.AutoDownloaderProfile{
				Conditions: []dto.AutoDownloaderCondition{{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 10}},
			},
			expectedQueued: 1,
		...
		},
		{
			...
			profile: &dto.AutoDownloaderProfile{
				Conditions:     []dto.AutoDownloaderCondition{{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 100}},
				DelayMinutes:   10,
				SkipDelayScore: 50,
			},
		...
		},
		{
			...
			profile: &dto.AutoDownloaderProfile{
				Conditions: []dto.AutoDownloaderCondition{
					{Term: "BetterGroup", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 20},
					{Term: "1080p", Action: dto.AutoDownloaderProfileRuleFormatActionScore, Score: 0},
				},
				DelayMinutes:   10,
				SkipDelayScore: 50,
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Setup Rule/Profile
			_ = db.InsertAutoDownloaderProfile(ad.database, tt.profile)
			_ = db.InsertAutoDownloaderRule(ad.database, &dto.AutoDownloaderRule{
				DbID: 1, Enabled: true, MediaId: mediaId, ProfileID: lo.ToPtr(uint(1)),
				EpisodeType: dto.AutoDownloaderRuleEpisodeRecent, ComparisonTitle: "Sousou no Frieren", TitleComparisonType: dto.AutoDownloaderRuleTitleComparisonLikely,
			})
