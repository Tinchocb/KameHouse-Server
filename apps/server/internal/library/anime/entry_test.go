		...
		},
		{
			...
			localFiles: anime.MockHydratedLocalFiles(
				anime.MockGenerateHydratedLocalFileGroupOptions("E:/Anime", "E:/Anime/Mushoku Tensei II Isekai Ittara Honki Dasu/[SubsPlease] Mushoku Tensei S2 - 00 (1080p) [9C362DC3].mkv", 146065, []anime.MockHydratedLocalFileWrapperOptionsMetadata{
					{MetadataEpisode: 0, MetadataAniDbEpisode: "S1", MetadataType: dto.LocalFileTypeMain}, // Special episode
					{MetadataEpisode: 1, MetadataAniDbEpisode: "1", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 2, MetadataAniDbEpisode: "2", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 3, MetadataAniDbEpisode: "3", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 4, MetadataAniDbEpisode: "4", MetadataType: dto.LocalFileTypeMain},
					...
					{MetadataEpisode: 8, MetadataAniDbEpisode: "8", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 9, MetadataAniDbEpisode: "9", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 10, MetadataAniDbEpisode: "10", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 11, MetadataAniDbEpisode: "11", MetadataType: dto.LocalFileTypeMain},
					{MetadataEpisode: 12, MetadataAniDbEpisode: "12", MetadataType: dto.LocalFileTypeMain},
				}),
			),
			currentProgress:                   0,
