...
// This allows updates even if KameHouse is removed from GitHub
var (
	websiteUrl        = "https://kamehouse.app/api/release"
	fallbackGithubUrl = "https://api.github.com/repos/5rahim/kamehouse/releases/latest"
)
...
func (u *Updater) GetReleaseName(version string) string {
	...
	return fmt.Sprintf("KameHouse-%s_%s_%s.%s", version, oos, arch, ext)
}
...
func (u *Updater) fetchLatestReleaseFromGitHub() (*Release, error) {
	return nil, errors.New("github fallback disabled")
}
