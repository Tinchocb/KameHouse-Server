...
func TestUpdater_FetchLatestRelease(t *testing.T) {
	t.Skip("Skipping: requires live kamehouse.app and GitHub API endpoints")

	fallbackGithubUrl = "https://KameHousedud.app/api/releases" // simulate dead endpoint
	//githubUrl = "https://api.github.com/repos/5rahim/kamehouse-desktop/releases/latest"
...
func TestUpdater_FetchLatestReleaseFromGitHub(t *testing.T) {
	t.Skip("Skipping: requires live GitHub API for 5rahim/kamehouse repo")
