...
import (
	"fmt"
	qbittorrent_application "kamehouse/internal/torrent_clients/qbittorrent/application"
	qbittorrent_log "kamehouse/internal/torrent_clients/qbittorrent/log"
	qbittorrent_rss "kamehouse/internal/torrent_clients/qbittorrent/rss"
	qbittorrent_search "kamehouse/internal/torrent_clients/qbittorrent/search"
	qbittorrent_sync "kamehouse/internal/torrent_clients/qbittorrent/sync"
	qbittorrent_torrent "kamehouse/internal/torrent_clients/qbittorrent/torrent"
	qbittorrent_transfer "kamehouse/internal/torrent_clients/qbittorrent/transfer"
	"net/http"
	"net/http/cookiejar"
	"net/url"
	"strings"
