                                    ...
                                    >
                                        ...
                                        <div className="flex-1 -mt-0.5">
                                            <label
                                                ...
                                                className="text-xs font-bold text-white block tracking-tight cursor-pointer group-hover:text-[#ff6e3a] transition-colors"
                                            >
                                                {gpu.label}
                                            </label>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="flex flex-col gap-2">
                                <label htmlFor="hw-custom-settings" className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Parámetros Personalizados (Avanzado)</label>
                                <input
            ...
            <Section label="Pre-Transcodificación (Background)">
                <Card className="divide-y divide-white/[0.04]">
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="flex flex-col md:flex-row md:items-center justify-between px-6 py-4 hover:bg-white/[0.01] transition-all duration-200 gap-5 group/input">
                                <div className="space-y-0.5 flex-1 max-w-xl">
                                    <label htmlFor="pretranscode-dir" className="text-sm font-semibold text-zinc-200 group-hover/input:text-white transition-colors tracking-tight cursor-pointer">Directorio de Pre-Transcodificación</label>
                                    <p className="text-xs text-zinc-500 leading-relaxed font-medium">Carpeta donde se guardan los archivos pre-transcodificados.</p>
                                </div>
                                <input
                                    id="pretranscode-dir"
                                    type="text"
                ...
                <Card className="divide-y divide-white/[0.04]">
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="flex flex-col md:flex-row md:items-center justify-between px-6 py-4 hover:bg-white/[0.01] transition-all duration-200 gap-5 group/input">
                                <div className="space-y-0.5 flex-1 max-w-xl">
                                    <label htmlFor="ffmpeg-path-stream" className="text-sm font-semibold text-zinc-200 group-hover/input:text-white transition-colors tracking-tight cursor-pointer">Ruta Ejecutable FFmpeg</label>
                                    <p className="text-xs text-zinc-500 leading-relaxed font-medium">Ubicación del binario ffmpeg (requerido para transcodificación).</p>
                                </div>
                                <input
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="flex flex-col md:flex-row md:items-center justify-between px-6 py-4 hover:bg-white/[0.01] transition-all duration-200 gap-5 group/input">
                                <div className="space-y-0.5 flex-1 max-w-xl">
                                    <label htmlFor="ffprobe-path-stream" className="text-sm font-semibold text-zinc-200 group-hover/input:text-white transition-colors tracking-tight cursor-pointer">Ruta Ejecutable FFprobe</label>
                                    <p className="text-xs text-zinc-500 leading-relaxed font-medium">Ubicación del binario ffprobe (análisis de metadatos de video).</p>
                                </div>
                                <input
