...
function SettingsPage() {
    ...
    return (
        <div className="flex h-full w-full bg-transparent text-zinc-300 selection:bg-[#ff6e3a]/30 overflow-hidden relative">
            {/* ── Left Sidebar Nav ─────────────────────────────────────── */}
            <nav
                className="relative w-[260px] shrink-0 h-full flex flex-col border-r border-border-strong bg-surface-1/70 backdrop-blur-xl overflow-y-auto no-scrollbar"
                onMouseMove={(e) => {
            ...
            >
                ...
                {sidebarMousePos.show && (
                    <div
                        ...
                        style={{
                            background: `radial-gradient(240px circle at ${sidebarMousePos.x}px ${sidebarMousePos.y}px, rgba(255,110,58,0.08), transparent 80%)`,
                            opacity: 1,
                        }}
                    />
                )}
                ...
                <div className="relative z-10 px-6 pt-8 pb-6">
                    <div className="flex items-center gap-2.5 mb-3">
                        <span className="w-2 h-2 rounded-full bg-[#ff6e3a] shadow-[0_0_10px_#ff6e3a] animate-pulse" />
                    ...
                    <div className="h-[2px] w-10 bg-gradient-to-r from-[#ff6e3a] to-transparent rounded-full mt-3 shadow-[0_0_10px_rgba(255,110,58,0.6)]" />
                </div>
                            ...
                            >
                                {isActive && (
                                    <motion.div
                                        ...
                                        className="absolute inset-0 rounded-xl bg-[#ff6e3a]/[0.1] border border-[#ff6e3a]/20 shadow-[0_0_20px_rgba(255,110,58,0.08)]"
                                ...
                                <div className={cn(
                                    ...
                                    isActive
                                        ? "bg-[#ff6e3a]/20 text-[#ff6e3a] shadow-[0_0_12px_rgba(255,110,58,0.15)]"
                                        : "bg-surface-2/60 text-zinc-500 group-hover:text-zinc-300 group-hover:bg-surface-3/60"
                                )}>
                                ...
                                {isActive && (
                                    <div className="relative z-10 w-1.5 h-1.5 rounded-full bg-[#ff6e3a] shadow-[0_0_8px_#ff6e3a] shrink-0" />
                                )}
                            </button>
                        )
                    })}
                ...
                <div className="relative z-10 px-6 py-5 border-t border-border-subtle">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden">
                {/* Content header */}
                <header className="shrink-0 px-8 md:px-12 lg:px-16 pt-8 pb-6 border-b border-border-subtle">
                    <div className="flex items-center gap-2 mb-2">
                        {(() => {
                            ...
                            return (
                                <>
                                    <div className="w-8 h-8 rounded-lg bg-[#ff6e3a]/10 border border-[#ff6e3a]/20 flex items-center justify-center">
                                        <Icon className="h-4 w-4 text-[#ff6e3a]" />
                                    </div>
                    ...
                    <div className="h-[2px] w-10 bg-gradient-to-r from-[#ff6e3a]/60 to-transparent rounded-full mt-3" />
                </header>
            ...
            <AnimatePresence>
                {isDirty && (
                    <motion.div
                        ...
                        className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-8 liquid-glass-frosted px-6 py-4"
                    >
                        <div className="flex items-center gap-3 pl-1">
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ff6e3a] opacity-75" />
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#ff6e3a] shadow-[0_0_8px_#ff6e3a]" />
                            </span>
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                type="button"
                                onClick={() => reset()}
                                className="text-xs font-bold text-zinc-400 hover:text-white transition-all px-3 py-1.5 hover:bg-surface-2/60 rounded-lg active:scale-95"
                            >
                                Descartar
                            </button>
                            <button
                                ...
                                form="settings-form"
                                disabled={isSaving}
                                className="bg-[#ff6e3a] hover:bg-[#ff7d4b] text-zinc-950 px-5 py-2.5 rounded-xl text-xs font-black transition-all duration-300 disabled:opacity-50 uppercase tracking-widest active:scale-95 shadow-lg shadow-orange-500/25"
                            >
