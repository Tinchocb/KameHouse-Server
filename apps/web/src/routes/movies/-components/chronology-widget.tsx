...
export function ChronologyWidget({ chronology }: ChronologyWidgetProps) {
  ...
  return (
    <div className="bg-[var(--glass-bg)] backdrop-blur-[var(--blur-overlay-md)] border border-[var(--glass-border)] rounded-2xl p-6 mt-8 hover:bg-[var(--glass-hover)] hover:border-[var(--glass-strong)] transition-all duration-300 cursor-pointer">
      ...
      <div className="relative flex items-center justify-between w-full max-w-2xl mx-auto px-4">
        ...
        <div className="absolute left-1/4 right-1/4 h-1 bg-gradient-to-r from-amber-500/20 via-amber-500 to-brand-secondary/20 top-1/2 -translate-y-1/2 rounded-full z-0 shadow-[0_0_10px_rgba(245,158,11,0.5)]" />
