...
export const SeriesCard = memo(function SeriesCard({
    ...
    return (
        <div
            ...
            style={{
                flex: isSelected ? '4 0 450px' : '0 0 135px',
                transition: 'flex 700ms cubic-bezier(0.2, 1, 0.2, 1), transform 500ms cubic-bezier(0.2, 1, 0.2, 1)',
                willChange: "flex-grow, transform",
                backgroundImage: (!isSelected && panoramaUrl) ? `url(${panoramaUrl})` : undefined,
                backgroundSize: (!isSelected && panoramaUrl) ? "500% 100%" : undefined,
                backgroundPosition: (!isSelected && panoramaUrl) ? `calc(${spineCfg.colIndex} * 25%) 0%` : undefined,
                background: (!isSelected && !panoramaUrl) ? spineCfg.bg : undefined,
        ...
        >
            {isSelected ? (
                // --- SELECTED / EXPANDED COVER DESIGN ---
                <div className="flex-1 flex flex-col min-h-0 w-full relative bg-zinc-950">
                    ...
                    {/* Bottom Horizontal Cassette spine block */}
                    <div
                ...
                // --- COLLAPSED / SLICED GOKU PANORAMA SPINE ---
                <div
                ...
                >
                    {/* Glossy overlay to simulate the plastic sleeve wrapping of a real box */}
                    <div className="absolute inset-0 bg-gradient-to-b from-white/[0.08] via-transparent to-black/[0.3] pointer-events-none z-10" />

                    {/* Top Section: Volume circle & Subtitle */}
                    <div className="z-20 flex flex-col items-center gap-1.5 mt-2">
                        <div
                            ...
                            style={{
                                backgroundColor: '#ffd54f', // Retro yellow
                                color: '#1c1917'
                            }}
                        >
                            {spineCfg.vol}
                        ...
                        <span
                            className="text-[8px] font-black tracking-[0.2em] uppercase opacity-75"
                    ...
                    {/* Middle Section: Vertical Title */}
                    <div className="z-20 flex-1 flex items-center justify-center my-4 w-full">
                        <h3
                    ...
                    {/* Compact progress indicator line at the very bottom edge */}
                    <div className="z-30 w-full px-2 shrink-0 mt-auto">
