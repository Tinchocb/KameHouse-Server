...
export const SeriesCard = memo(function SeriesCard({
    ...
    const bgGradient = useMemo(() => {
        if (!dominantColors || dominantColors.length < 3) return spineCfg?.bg || 'linear-gradient(to bottom, #1e293b, #0f172a)';
    ...
    return (
        <article
            ...
            style={{
                ...
                transition: 'flex 500ms cubic-bezier(0.2, 1, 0.2, 1)',
        ...
        >
            {/* ─── VHS TAPE BODY ─── */}
            <div 
                className="flex-1 min-h-0 relative overflow-hidden bg-[#0a0d16] rounded-t-lg transition-all duration-500"
                style={{
            ...
            >
                ...
                >
                    <div className={cn(
                        ...
                        {isSelected && (
                            <p className="text-white/50 text-xs leading-relaxed mb-3 font-medium line-clamp-2 delay-180 transition-all duration-400">
                                {item.desc}
                            </p>
                        )}
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-12 h-12 rounded-full bg-black/90 border border-zinc-800 shadow-[inset_0_3px_6px_rgba(0,0,0,0.8)] flex items-center justify-center shrink-0">
                        ...
                        >
                            <svg className="w-10 h-10 text-zinc-700/50" viewBox="0 0 100 100" fill="none">
                    ...
                    <div className="flex flex-col items-center justify-center shrink-0 px-2">
                        <span className="font-mono text-[9px] font-black tracking-widest" style={{ color: eraGradientFrom, fontFamily: "'Space Mono', monospace" }}>
                            KAME-VHS
                        </span>
                        <span className="text-[7px] font-bold text-zinc-600 tracking-widest uppercase mt-0.5">
                            {item.year}
                        </span>
                    </div>
                ...
                >
                    {/* VHS Label */}
                    <div className="h-[94px] relative flex flex-col rounded shadow-[2px_4px_10px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.25)] overflow-hidden transition-all duration-400 ease-out shrink-0 w-[calc(100%-6px)] mx-auto bg-[#fbf9f1] border border-black/10">
                        ...
                        <div className="relative z-10 bg-[#0d0d0d] flex items-center justify-between px-1.5 py-0.5 select-none border-b border-black/20">
                            <span className="font-extrabold text-[7px] uppercase tracking-wider leading-none" style={{ color: eraGradientFrom, fontFamily: "'Space Mono', monospace" }}>
                                KAME-VHS
                            </span>
                            <span className="text-[6px] font-bold text-zinc-600 tracking-wider">
                                {item.eps} EP
                            </span>
                        </div>
