                ...
                {generatedSagas.length > 0 && (
                    <aside className="w-full lg:w-[400px] shrink-0">
                        <div className="sticky top-24 flex flex-col gap-6">
                            ...
                            <div className="flex flex-col liquid-glass-frosted rounded-2xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="flex items-center gap-4 shrink-0 self-start sm:self-auto">
                                        ...
                                        {activeMainSaga && onUpdateProgress && (
                                            <div className="relative group/actions">
                                                <button className="flex items-center gap-2 px-4 py-2.5 liquid-glass-frosted liquid-glass-frosted-interactive rounded-xl text-[10px] font-black tracking-widest text-zinc-400 hover:text-white uppercase transition-all duration-300 shadow-md">
                                                    <span>Progreso</span>
                                                ...
                                                <div className="absolute right-0 top-full mt-2 w-56 origin-top-right rounded-2xl liquid-glass-frosted p-2 shadow-2xl opacity-0 scale-95 pointer-events-none group-hover/actions:opacity-100 group-hover/actions:scale-100 group-hover/actions:pointer-events-auto transition-all duration-300 z-50">
                                                    <button
                                                        onClick={() => {
                                        ...
                                        <div className="flex items-center gap-2 liquid-glass-frosted p-1.5 rounded-xl">
                                            <button
