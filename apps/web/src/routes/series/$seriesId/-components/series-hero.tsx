      ...
      <div className="relative z-20 w-full max-w-[1800px] mx-auto px-6 sm:px-12 pb-10 pt-48 flex flex-col lg:flex-row lg:items-end justify-between gap-12">
        <div className="max-w-3xl space-y-7">
          ...
          <div className="series-hero-animate space-y-2">
            {romajiTitle && (
              <h2 className="text-brand-orange font-bold uppercase tracking-[0.25em] text-xs md:text-sm animate-ki-shimmer bg-gradient-to-r from-brand-orange via-amber-500 to-brand-orange bg-clip-text text-transparent select-none drop-shadow-[0_2px_8px_rgba(255,110,58,0.25)]">
                {romajiTitle}
              </h2>
            )}
          ...
          {/* Synopsis */}
          <p className="series-hero-animate text-zinc-300 text-sm md:text-base leading-relaxed line-clamp-3 drop-shadow-md font-medium select-none max-w-2xl border-l-[3px] border-brand-orange/20 pl-4 py-0.5">
            {synopsis}
          </p>
          ...
          <div className="series-hero-animate flex flex-wrap items-center gap-4 pt-2">
            ...
            >
              ...
              <div className="p-3 bg-black/40 backdrop-blur-xl rounded-xl border border-white/10 text-white group-hover/play:bg-white group-hover/play:text-black transition-all duration-300 shadow-inner z-10 shrink-0">
            ...
            {entry?.localFiles && entry.localFiles.length > 0 && (
              <button
                ...
                className="group/queue flex items-center justify-center p-4.5 rounded-2xl liquid-glass-frosted liquid-glass-frosted-interactive text-white/70 hover:text-white transition-all duration-300 shadow-lg"
