...
import type {
    Platform_AiringSort,
    Platform_BaseAnime,
    Platform_FuzzyDateInput,
    Platform_MediaFormat,
    Platform_MediaListStatus,
    Platform_MediaSeason,
    Platform_MediaSort,
...
export type PlatformListRecentAnime_Variables = {
    page?: number
    perPage?: number
...
/**
 * - Filepath: internal/handlers/Platform.go
 * - Filename: Platform.go
 * - Endpoint: /api/v1/Platform/list-entry
 * @description
 * Route updates the user's list entry on Platform.
 */
export type EditPlatformListEntry_Variables = {
    mediaId?: number
    status?: Platform_MediaListStatus
    score?: number
    progress?: number
    startedAt?: Platform_FuzzyDateInput
    completedAt?: Platform_FuzzyDateInput
    type: string
}
 ...
 * - Filepath: internal/handlers/Platform.go
 * - Filename: Platform.go
 * - Endpoint: /api/v1/Platform/media-details/{id}
 * @description
 * Route returns more details about an Platform anime entry.
 */
export type GetPlatformAnimeDetails_Variables = {
    /**
     *  The Platform anime ID
     */
    id: number
}
 ...
 * - Filepath: internal/handlers/Platform.go
 * - Filename: Platform.go
 * - Endpoint: /api/v1/Platform/studio-details/{id}
 * @description
 * Route returns details about a studio.
 */
export type GetPlatformStudioDetails_Variables = {
    /**
     *  The Platform studio ID
     */
    id: number
}
 ...
 * - Endpoint: /api/v1/Platform/list-entry
 * @description
 * Route deletes an entry from the user's Platform list.
 */
export type DeletePlatformListEntry_Variables = {
    mediaId?: number
    type?: string
}
 ...
 */
export type PlatformListAnime_Variables = {
    page?: number
    search?: string
    perPage?: number
    sort?: Array<Platform_MediaSort>
    status?: Array<Platform_MediaStatus>
    genres?: Array<string>
 ...
 */
export type PlatformListRecentAiringAnime_Variables = {
    page?: number
    search?: string
    perPage?: number
    ...
    notYetAired?: boolean
    sort?: Array<Platform_AiringSort>
    libraryOnly?: boolean
}
...
export type GetAutoDownloaderRulesByAnime_Variables = {
    /**
     *  The Platform anime id of the rules
     */
    id: number
}
...
export type Progress_UserMediaProgress = {
    id: number
    createdAt: string
    updatedAt: string
    anonUserId: string
...
export type SaveProgress_Variables = {
    mediaId: number
    status: string
    progress: number
    score: number
