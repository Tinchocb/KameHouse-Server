...
export function ResumeOverlay({ show, time, onResume, onClose }: { show: boolean, time: number, onResume: () => void, onClose: () => void }) {
    ...
    return (
        <div className="absolute bottom-32 left-10 z-50 pointer-events-auto animate-in slide-in-from-left-4 duration-500">
            <div className="bg-black/90 backdrop-blur-xl border border-white/20 p-5 flex flex-col gap-4 min-w-[280px] shadow-2xl">
                ...
                <div className="flex gap-2">
                    <button 
                        onClick={onResume}
                        className="flex-1 py-2.5 bg-white text-black font-black text-[9px] uppercase tracking-widest hover:bg-zinc-300 transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    <button 
                        onClick={onClose}
                        className="flex-1 py-2.5 bg-white/10 text-white font-black text-[9px] uppercase tracking-widest hover:bg-white/20 transition-all"
                    >
                        IGNORAR
                    </button>
                </div>
