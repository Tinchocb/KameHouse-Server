...
export function MediaCardInteractive({
    ...
    return (
        <button
            type="button"
            className="group relative w-full cursor-pointer text-left outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b00] rounded-2xl overflow-hidden"
            onClick={onClick}
        ...
        >
            ...
            <motion.div 
                layoutId={layoutId}
                className="aspect-[2/3] relative overflow-hidden rounded-2xl"
            >
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/0 opacity-0 backdrop-blur-none transition-all duration-300 group-hover:bg-black/50 group-hover:opacity-100 group-hover:backdrop-blur-sm">
                    <div className="flex h-14 w-14 transform items-center justify-center rounded-full bg-[#ff6b00] text-white shadow-[0_0_30px_rgba(255,107,0,0.6)] transition-transform duration-300 group-hover:scale-110">
                ...
                {(year || rating || badge) && (
                    ...
                    >
                        <div className="flex items-center justify-between gap-2 rounded-b-2xl bg-black/80 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/90 backdrop-blur">
                ...
                {progress !== undefined && progress > 0 && progress < 100 && (
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-white/10 z-20">
                        <div
                            className="h-full bg-[#ff6b00] shadow-[0_0_10px_rgba(255,107,0,0.8)] transition-all duration-300"
