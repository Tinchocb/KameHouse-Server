...
// ─────────────────────────────────────────────────────────────────────────────
// Mock data factory (dev / storybook)
// ─────────────────────────────────────────────────────────────────────────────

/**
 * Generates a realistic mix of local and torrentio sources.
 * Useful in Storybook or a standalone demo page.
 */
export function getMockSources(episodeTitle: string): StreamSource[] {
    return [
        // ── Local files ──
        {
            id: "local-1080-x265",
            type: "local",
            label: `${episodeTitle} [1080p BluRay REMUX].mkv`,
            quality: "1080p",
            size: "4.2 GB",
            audio: "Japonés + Sub ES",
            codec: "x265",
        },
        {
            id: "local-720-x264",
            type: "local",
            label: `${episodeTitle} [720p WEB-DL].mp4`,
            quality: "720p",
            size: "1.1 GB",
        ...
        // ── Torrentio ──
        {
            id: "torrentio-4khdr",
            type: "torrentio",
            label: `${episodeTitle} [4K HDR DV 2160p].mkv`,
            quality: "4K HDR",
            size: "21 GB",
            audio: "Multi-Audio",
            codec: "AV1",
            seeders: 284,
            releaseGroup: "Hi10P",
            magnetUri: "magnet:?xt=urn:btih:DUMMY_HASH_4KHDR",
            infoHash: "DUMMY_HASH_4KHDR",
            fileIdx: 0,
        },
        {
            id: "torrentio-4k",
            type: "torrentio",
            label: `${episodeTitle} [2160p HEVC HDR10].mkv`,
            quality: "4K",
            size: "14 GB",
            audio: "Japonés",
            codec: "HEVC",
            seeders: 142,
            releaseGroup: "UHD-BluRay",
            magnetUri: "magnet:?xt=urn:btih:DUMMY_HASH_4K",
            infoHash: "DUMMY_HASH_4K",
            fileIdx: 0,
        },
        {
            id: "torrentio-1080-subsplease",
            type: "torrentio",
            label: `${episodeTitle} [1080p WEB].mkv`,
            quality: "1080p",
            size: "1.4 GB",
            audio: "Japonés",
            codec: "H264",
            ...
            magnetUri: "magnet:?xt=urn:btih:DUMMY_HASH_1080SP",
            infoHash: "DUMMY_HASH_1080SP",
            fileIdx: 0,
        },
        {
            id: "torrentio-1080-erai",
            type: "torrentio",
            label: `${episodeTitle} [1080p WEB-DL].mkv`,
            quality: "1080p",
            size: "1.2 GB",
            audio: "Japonés + Sub EN",
            codec: "x264",
            seeders: 67,
            releaseGroup: "Erai-raws",
            magnetUri: "magnet:?xt=urn:btih:DUMMY_HASH_1080ER",
            infoHash: "DUMMY_HASH_1080ER",
            fileIdx: 0,
        },
        {
            id: "torrentio-720",
            type: "torrentio",
            label: `${episodeTitle} [720p WEB].mkv`,
            quality: "720p",
            size: "680 MB",
            audio: "Japonés",
            codec: "x264",
            seeders: 28,
            releaseGroup: "SubsPlease",
            magnetUri: "magnet:?xt=urn:btih:DUMMY_HASH_720",
            infoHash: "DUMMY_HASH_720",
            fileIdx: 0,
        },
    ]
}
