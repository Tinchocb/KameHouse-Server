...
// Previously imported from schedule-calendar, defined locally since schedule module was removed
export const weekStartsOnAtom = atomWithStorage<number>("sea-week-starts-on", 0, undefined, { getOnInit: true })
