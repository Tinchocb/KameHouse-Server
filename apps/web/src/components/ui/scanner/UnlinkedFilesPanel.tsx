...
const FileCard = React.forwardRef<HTMLDivElement, { file: GhostFile }>(function FileCard({ file }, ref) {
    ...
    return (
        <motion.div
            ...
            className="bg-[var(--glass-bg)] backdrop-blur-[var(--blur-overlay-md)] border border-[var(--glass-border)] rounded-2xl overflow-hidden group hover:bg-[var(--glass-hover)] hover:border-[var(--glass-strong)] transition-all duration-300"
        >
            {/* ─── Header row ─── */}
            <button
                type="button"
                                    ...
                                    {results.slice(0, 10).map(r => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="w-full flex items-center gap-6 p-4 rounded-2xl bg-[var(--glass-bg)] backdrop-blur-[var(--blur-overlay-sm)] border border-[var(--glass-border)] hover:bg-[var(--glass-hover)] hover:border-[var(--glass-strong)] transition-all text-left group/result relative overflow-hidden"
                                            >
...
export function UnlinkedFilesPanel() {
    ...
    if (unresolved.length === 0) return (
        <div className="flex items-center gap-6 p-8 rounded-3xl bg-[var(--glass-bg)] backdrop-blur-[var(--blur-overlay-md)] border border-[var(--glass-border)]">
    ...
    return (
        <div className="space-y-8">
            {/* ─── Header Bento ─── */}
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-8 rounded-3xl bg-[var(--glass-bg)] backdrop-blur-[var(--blur-overlay-md)] border border-[var(--glass-border)] relative overflow-hidden group">
