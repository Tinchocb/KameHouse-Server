...
/**
 * Generates realistic mock stream sources for a given episode.
 * In production this would be fetched from the server / Torrentio API.
 */
    ...
    return [
        {
            id: "local-1080",
            type: "local",
            label: `${episodeTitle} [1080p BluRay].mkv`,
            quality: "1080p",
            info: "4.2 GB",
        ...
        },
        {
            id: "torrentio-4k",
            type: "torrentio",
            label: `${episodeTitle} [4K HDR DV].mkv`,
            quality: "4K HDR",
            info: "Seeders: 284",
            audio: "Multi-Audio",
            codec: "AV1",
        ...
        },
        {
            id: "torrentio-1080",
            type: "torrentio",
            label: `${episodeTitle} [1080p WEB H264].mkv`,
            quality: "1080p",
            info: "Seeders: 67",
            audio: "Español Latino",
            codec: "x264",
