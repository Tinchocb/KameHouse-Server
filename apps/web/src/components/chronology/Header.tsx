    ...
    <section className="relative w-full px-4 sm:px-6 md:px-8 xl:px-12 2xl:px-16 pt-4 md:pt-12 pb-4 space-y-4 select-none shrink-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5 min-w-0">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-amber-500 via-amber-400 to-yellow-300 p-[2px] shadow-[0_0_24px_rgba(245,158,11,0.45)] shrink-0">
            <div className="w-full h-full bg-amber-950/60 backdrop-blur-md rounded-[10px] flex items-center justify-center border border-amber-400/30">
      ...
      <div className="pt-1 flex flex-col gap-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-0.5">
          <div className="flex items-center gap-1.5 p-1 rounded-full bg-white/[0.04] border border-white/10 backdrop-blur-overlay-md text-xs font-mono">
            ...
            {(
              ...
              return (
                <button
                  ...
                  className={`relative min-h-[36px] px-3.5 py-1 rounded-full text-xs font-mono font-medium transition-all duration-150 cursor-pointer select-none active:scale-95 flex items-center gap-1.5 ${
                    isSelected
                      ? 'bg-brand-accent text-zinc-950 font-bold shadow-sm'
