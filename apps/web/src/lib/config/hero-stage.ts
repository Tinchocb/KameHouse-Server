...
export const HERO_STAGE_CLASS =
    "aspect-[16/9] sm:aspect-[1.9/1] lg:aspect-[1.85/1] min-h-[528px] sm:min-h-[616px] lg:min-h-[min(682px,max(540px,calc(100dvh-218px)))] max-h-[748px] lg:max-h-[min(748px,max(540px,calc(100dvh-218px)))]"
...
export const HERO_AURA_CLASS =
    "absolute top-0 inset-x-0 h-[528px] sm:h-[616px] md:h-[682px] lg:h-[726px] pointer-events-none overflow-hidden z-0 transform-gpu"
