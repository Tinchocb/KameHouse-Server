...
export const ERA_DEFAULTS: Record<EraId, EraDefaultInfo> = {
    ...
    dbgt: {
        ...
        backdropUrl: "/backdrops/dbgt.jpg",
    ...
    dbkai: {
        ...
        backdropUrl: "/backdrops/dbkai.jpg",
    ...
    dbdaima: {
        ...
        backdropUrl: "/backdrops/dbdaima.jpg",
