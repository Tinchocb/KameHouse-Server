...
const config: Config = {
    ...
    theme: {
        ...
        extend: {
            ...
            "brand-primary": "hsl(var(--color-db-hsl) / <alpha-value>)",
            "brand-secondary": "hsl(var(--color-dbz-hsl) / <alpha-value>)",
            "brand-destructive": "hsl(var(--color-dbgt-hsl) / <alpha-value>)",
            "brand-success": "hsl(var(--color-dbs-hsl) / <alpha-value>)",
            "brand-magic": "hsl(var(--color-daima-hsl) / <alpha-value>)",
            color: {
                db: "hsl(var(--color-db-hsl) / <alpha-value>)",
                dbz: "hsl(var(--color-dbz-hsl) / <alpha-value>)",
                dbgt: "hsl(var(--color-dbgt-hsl) / <alpha-value>)",
                dbs: "hsl(var(--color-dbs-hsl) / <alpha-value>)",
                daima: "hsl(var(--color-daima-hsl) / <alpha-value>)",
            },
            bg: {
